...
public class JavazoosApplication {
    private static final Logger logger = LoggerFactory.getLogger(JavazoosApplication.class);
    ...
    public static void main(String[] args) {
        ...
        if (!stop) {
            ApplicationContext ctx = SpringApplication.run(JavazoosApplication.class,
                    args);
